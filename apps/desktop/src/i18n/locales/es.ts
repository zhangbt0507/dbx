...
export default withEnglishFallback({
  ...
  connection: {
    ...
    savePasswordHint: "Desmarcar para solicitarla en cada conexión",
    promptPasswordTitle: "Introducir contraseña",
    promptPasswordMessage: "Introduzca la contraseña de la conexión “{connection}”.",
  ...
  settings: {
    ...
    save: "Guardar",
    cancel: "Cancelar",
    executeMode: "Modo de ejecución ({shortcut})",
  ...
  mqMessages: {
    ...
    kafkaLatestHint: "Lee hasta N candidatos por partición y devuelve los N más recientes del tema por marca de tiempo.",
