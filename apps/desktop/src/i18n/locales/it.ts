...
export default withEnglishFallback({
  ...
  connection: {
    ...
    savePasswordHint: "Deseleziona per richiederla a ogni connessione",
    promptPasswordTitle: "Inserisci password",
    promptPasswordMessage: "Inserisci la password per la connessione “{connection}”.",
  ...
  settings: {
    ...
    save: "Salva",
    cancel: "Annulla",
    executeMode: "Modalità Esecuzione ({shortcut})",
