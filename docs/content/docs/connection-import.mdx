...
<Steps>
  ...
  <Step>
    ...
    DBX combines driver references, database product names, JDBC subprotocols, and driver classes. Databases such as KingBase map to their DBX profile; unknown drivers remain generic JDBC.
